...
public class UsuarioRepositoryImpl implements UsuarioRepository {
    ...
    public UsuarioRepositoryImpl() {
        ...
        listaUsuarios.add(new UsuarioEntity(1,"jperezgil", "123", "Juan Perez", true));
        listaUsuarios.add(new UsuarioEntity(2,"mariag", "456", "Maria Garcia", true));
        listaUsuarios.add(new UsuarioEntity(3,"carlosl", "789", "Carlos Lopez", false));
    }
